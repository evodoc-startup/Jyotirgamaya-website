...
function Services() {
  const services = [
    ...
    },
    {
      ...
      bestFor: "Children aged 5–12 experiencing behavioral or emotional issues.",
      color: "pink",
      lineColor: "#79FFEF",
      image: "/service-2.png"
    },
  ...
  return (
    <section>
      <div className='w-full px-10 py-10 bg-moonstone text-center'>
        ...
        <p className='mt-5 text-white tracking-wider font-semibold'>
          Discover comprehensive psychological services designed to support your mental health and personal growth. Whether you're seeking individual therapy, group counseling, or family support, we offer tailored solutions to help you thrive. With experienced professionals, evidence-based therapies, and a compassionate approach, we're here to guide you toward a better tomorrow.
        </p>
      </div>
      ...
      <div className='py-10 xl:px-52 lg:px-32 hidden lg:flex flex-col gap-y-24 mt-20'>
        {services.map((service, index) => {
          ...
          return (
            <div
              key={`service-${index}`}
              className={`w-full flex justify-around gap-x-16 ${isReversed ? 'flex-row-reverse' : ''}`}
            >
              <motion.div
              ...
              >
                <h3 className='text-3xl tracking-widest leading-normal'>{service.title}</h3>
                <div className='h-[1px] my-3 w-full' style={{ background: service.lineColor }}></div>
                ...
                <Link href='/' className='py-2 px-5 my-4 bg-[#FF9B28] text-white w-fit'>
                  Explore Now
                </Link>
              </motion.div>
              <motion.div
        ...
        {services.map((service, index) => (
          ...
          >
            ...
            <div className='w-full flex flex-col md:p-10 p-7'>
              ...
              <Link href='/' className='py-2 px-4 my-4 bg-[#FF9B28] text-white w-fit'>
                Explore Now
              </Link>
            </div>
          </motion.div>
