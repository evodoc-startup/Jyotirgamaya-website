        ...
        {internships.map((internship, index) => {
          ...
          return (
            <div
              ...
              className={`w-full flex justify-around gap-x-6 ${isReversed ? 'flex-row-reverse' : ''}`}
            >
              <motion.div
              ...
              >
                <h3 className='text-3xl tracking-widest leading-normal'>{internship.title}</h3>
                <div className='h-[1px] my-3 w-full' style={{ background: internship.lineColor }}></div>
