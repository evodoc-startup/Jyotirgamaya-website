...
function Main() {
    return (
        <main className='w-full flex md:flex-row flex-col-reverse items-center'>
            <motion.div className='md:w-1/2 w-full md:py-20 py-5 xl:pl-44 px-20'
            ...
            >
                ...
                <Link href={"/"} className='block w-fit my-8 px-6 py-2 rounded-xl text-white font-bold bg-blue'>
                    Know More
                </Link>
            </motion.div>
            <motion.div className='md:w-1/2 w-full flex justify-center items-center md:py-20 py-5'
